    ...
    public class SpiderTest
    {
       public static string file_path = string.Empty;
        ...
        protected CrawlConfig GetBaseConfig()
        {
            ...
            Trace.TraceInformation("XXXXXXXXXXXXXXXXXXXXXXXXXXXXX==="+templateBasePath);
            ...
            Trace.TraceInformation("SSSSSSSSSSSSSSSSSSSS===" + structureFilePath);
            Trace.TraceInformation("BBBBBBBBBBBBBBBBBBBB===" + behaviourFilePath);
